...
$(function() {
	 ...
	 $("#periodFrom").datepicker({
		...
		} else if (url.indexOf("isbn") > -1) {
		     $("#searchType").val("isbn").prop("selected", true);
		} else if (url.indexOf("writer") > -1) {
		     $("#searchType").val("writer").prop("selected", true);
		} else if (url.indexOf("publisher") > -1) {
		     $("#searchType").val("publisher").prop("selected", true);
		}
});
